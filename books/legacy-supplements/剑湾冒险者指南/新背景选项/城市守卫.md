...
**<span style="FONT-SIZE: 16pt">城市守卫<span lang="EN-US"> City Watch </span></span>**
...
**技能熟练项：**运动、洞悉  
**语言：**两门自选语言  
**装备：**一件你所在组织的标示你军衔的制服，一个用来召唤帮手的号角，一副手铐，以及一个装有<span lang="EN-US">10gp</span>的小包
...
<span style="FONT-SIZE: 12pt; FONT-FAMILY: 黑体; FONT-WEIGHT: bold; COLOR: rgb(128,0,0); mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 'Times New Roman'; mso-spacerun: 'yes'">建议特征</span>**<span style="FONT-SIZE: 12pt; FONT-FAMILY: 宋体; FONT-WEIGHT: bold; COLOR: rgb(128,0,0); mso-spacerun: 'yes'">Suggested Characteristics  
</span>**使用<span lang="EN-US">《玩家手册》</span>中“士兵”的特征表格作为你的基础特征和动机，并在适当的时候修改条目以让其符合你作为城市守卫的身份。  
